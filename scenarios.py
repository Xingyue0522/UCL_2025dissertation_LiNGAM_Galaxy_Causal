...
Note:
- When constructing scenarios for structure learning, variables with VIF > 10
  are excluded: PHYS2 = ["ssfr_mean", "age_mean", "metallicity_mean"].
- These variables are still used later when studying galaxy formation/quenching/
  synthesis pathways.
"""
...
SCENARIOS = [
    ...
    },
    {
        ...
        "category": "A_presence",
        "vars": PHYS + ["bar_prob", "bulge_ev", "spiral_prob_eff"],
        "filter": filt_all,
    ...
    # ---------- B: spiral geometry (hard gate) ----------
    {
        ...
        "vars": PHYS + ["bar_prob", "bulge_ev", "arms_num_ev", "arms_wind_ev"],
        "filter": filt_all,
